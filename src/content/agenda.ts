...
export const defaultAgenda: Agenda = {
  ...
  items: [
    ...
    { id: "spotlight-1", start: "09:30", end: "10:00", title: "From Proceedings: Spotlight Papers", detail: "Three 10-minute talks selected from accepted submissions", status: "confirmed", kind: "spotlight", speaker: "" },
    ...
    { id: "spotlight-2", start: "13:15", end: "13:45", title: "From Proceedings: Spotlight Papers", detail: "Three 10-minute talks selected from accepted submissions", status: "confirmed", kind: "spotlight", speaker: "" },
